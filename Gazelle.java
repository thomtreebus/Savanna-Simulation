...
public class Gazelle extends Prey
{
    ...
    //The food value of the gazelle when it is eaten
    private static final int FOOD_VALUE = 3;
    //The food level of the Gazelle when it is created
    private static final int INITIAL_FOOD_LEVEL = 8;
    //The max food level, once this value is reached, the Gazelle can't eat more.
    private static final int MAX_FOOD_LEVEL = 40;
    //The gazelle is not diurnal which means it is active during the night and sleeps during the day.
    private static final boolean DIURNAL = true;
    //A list of species that are part of the gazelle's diet.
    private static final List<String> EDIBLE_SPECIES = Arrays.asList("Grass");
    ...
    /**
     *
     * @param randomAge True if the gazelle is created with a random age,
     *                  False if the new gazelle is aged 0.
     * @param field The simulation field.
     * @param location Location to create the new gazelle.
     * @return The new gazelle
     */
    ...
    /**
     * @return The initial food level when the gazelle is created
     */
    ...
    /**
     * @return The gazelle's food value when eaten
     */
    ...
    /**
     * @return The list of species that the gazelle can eat.
     */
